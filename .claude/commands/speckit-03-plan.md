...
Follow the commit standards defined in `.claude/rules/git.md` to commit all planning artifacts including plan.md, research.md, data-model.md, contracts/, and quickstart.md files.

**Completion Report:**

- Branch name and plan file path
- Generated artifacts summary
- Readiness for task breakdown (`/speckit-05-tasks`)
...
- Completed and validated specification (`/speckit-01-specify` and `/speckit-02-clarify` commands)
...
- Run `/speckit-05-tasks` to break down implementation into specific tasks
